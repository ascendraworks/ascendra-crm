/*
  ...
  2. Security
    ...
    - Add policy for users to read/write their own leads only
    - Add policy for authenticated users to insert leads
    - Add policy for users to update their own leads
    - Add policy for users to delete their own leads
